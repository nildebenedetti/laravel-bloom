...
@section("content")
<div class="btns-wrapper container d-flex flex-column justify-content-between mt-3">
    <!-- Back to All btn-->
    ...
    <div class="btn-wrapper px-5 d-flex justify-content-end align-items-center">
        <a href="{{ route('emotions.create') }}" class="btn btn-outline-success">
            Add New
        </a>
    </div>
    <!--  Technologies Table -->
        ...
        <tbody>
            @foreach ($emotions as $emotion) 
                <tr>
                    ...
                    <td>
                        <a href="{{ route('emotions.show', $emotion) }}" class="action-btn btn btn-outline-info"><i class="bi bi-arrow-right"></i></a> 
                        <a href="{{ route('emotions.edit', $emotion)}}" class="action-btn btn btn-outline-warning"><i class="bi bi-pencil-fill"></i></a>
                        <button type="button" 
                                class="btn btn-outline-danger" 
                                data-bs-toggle="modal" 
                                data-bs-target="#deleteModal-{{ $emotion->id }}">
